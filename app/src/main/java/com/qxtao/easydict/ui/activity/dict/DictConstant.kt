...
const val WEB_TRANS_PART_MORE = "web_trans_part_more"
const val SPECIAL_PART_MORE = "special_part_more"
const val THESAURUS_PART_MORE = "thesaurus_part_more"
const val SYNONYM_PART_MORE = "synonym_part_more"
const val ANTONYM_PART_MORE = "antonym_part_more"
...
const val EE_FRAGMENT = 5
const val VOICE_AUTH_PART = 6
const val VOICE_BLNG_PART = 7
const val VOICE_EH_PART = 8
const val VOICE_NORMAL = 9
