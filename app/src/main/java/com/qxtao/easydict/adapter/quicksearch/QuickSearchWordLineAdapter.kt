package com.qxtao.easydict.adapter.quicksearch
...
class QuickSearchWordLineAdapter<T>(private val mItemData: ArrayList<T>) :
    RecyclerView.Adapter<QuickSearchWordLineAdapter<T>.ViewHolder>() {

    private var itemClickListener: OnItemClickListener? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_quick_search_wordline, parent, false)
